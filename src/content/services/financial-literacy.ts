...
export const financialLiteracy: ServicePage = {
  slug: "financial-literacy",
  title: "Financial Literacy",
  category: "Entrepreneurship",
  metaTitle: "Financial Literacy Training | Global Training Network",
  metaDescription:
    "Financial literacy training for entrepreneurs, families, and community groups. GTN teaches budgeting, credit, taxes, and smart money management in Canada.",
  hero: {
    headline: "Financial Literacy Training",
    subheadline:
...
GTN's financial literacy training connects personal and business finance. Entrepreneurs learn how personal financial health affects business decisions; families gain tools to manage household budgets alongside entrepreneurial aspirations. Our goal is to replace financial anxiety with confidence, knowledge, and practical habits that support long-term stability and growth.`,
  ...
  benefits: [
    ...
    {
      title: "Confidence & Long-Term Planning",
      description:
  ...
  process: [
    ...
    {
      step: 2,
      title: "Core Curriculum Delivery",
      description:
  ...
  faq: [
    {
      question: "Is financial literacy training suitable for newcomers to Canada?",
      answer:
        "Yes. We offer programs specifically designed for newcomers, covering Canadian banking, credit systems, tax filing basics, and government financial programs you may be eligible for.",
    },
    {
      question: "Does GTN provide investment or financial planning advice?",
      answer:
        "Our training focuses on financial literacy education, not licensed investment or financial planning advice. We teach foundational concepts and connect participants to qualified professionals when needed.",
    },
    {
      question: "Can financial literacy training be delivered as a group workshop?",
      answer:
        "Yes. GTN delivers workshops for community organizations, churches, schools, and employer groups. Contact us to discuss group size, format, and customization options.",
    },
    {
      question: "How does financial literacy support entrepreneurs?",
      answer:
        "Entrepreneurs who understand personal finance make stronger business decisions. Our training covers cash flow management, pricing, tax basics, and separating personal and business accounts—essential skills for sustainable ventures.",
    },
    {
      question: "How do I register for financial literacy training?",
      answer:
        "Book a consultation through our contact page or call our Langley office. We will discuss your learning goals and recommend individual coaching or group workshop options.",
    },
  ],
  relatedSlugs: [
