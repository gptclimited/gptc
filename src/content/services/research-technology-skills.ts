...
export const researchTechnologySkills: ServicePage = {
  slug: "research-technology-skills",
  subsidiary: "gtn",
  title: "Research Technology Skills",
  category: "Digital Skills",
  metaTitle: "Research Technology Skills Training | Global Training Network",
  metaDescription:
    "Master digital research tools, databases, and citation methods for academic and professional success. GTN trains students and professionals in research technology skills.",
  hero: {
    headline: "Research Technology Skills",
    subheadline:
...
GTN serves high school and post-secondary students, graduate researchers, educators, and professionals who need to produce well-sourced work. Sessions are available as workshops, course-integrated modules, or individualized coaching—in person or online. We meet learners at their level, from first-time university students encountering academic databases to experienced researchers updating their workflow with new technology. By completing our training, you will research faster, cite accurately, and produce work that meets the standards of Canadian and international academic and professional institutions. Contact GTN to discuss workshops, semester coaching, or course-integrated research skills modules.`,
  ...
  benefits: [
    {
      title: "Efficient Search Strategies",
      description:
  ...
  faq: [
    {
      question: "Which citation styles does GTN teach?",
      answer:
        "We provide training in APA, MLA, Chicago, and other formats commonly required by Canadian and international institutions. Tell us your program requirements during consultation and we will tailor content accordingly.",
    },
    {
      question: "Do I need access to a university library for this training?",
      answer:
        "University library access is helpful but not always required. We teach strategies using both institutional databases and publicly available scholarly resources.",
    },
    {
      question: "Can GTN help with thesis or dissertation research organization?",
      answer:
        "Yes. Graduate-level modules cover literature review strategies, reference management at scale, and maintaining organized research workflows across long projects.",
    },
    {
      question: "Does training address AI tools in research?",
      answer:
        "Yes. We cover responsible use of AI for brainstorming and summarization while emphasizing verification, citation, and the limits of AI-generated references.",
    },
    {
      question: "How do I book research technology skills training?",
      answer:
        "Contact us through our website or call 604-727-6553. We will discuss your research context and schedule an appropriate workshop or coaching session.",
    },
  ],
  relatedSlugs: [
    "digital-literacy",
