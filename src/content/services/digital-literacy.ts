...
export const digitalLiteracy: ServicePage = {
  ...
  metaDescription:
    "Build essential digital literacy skills for education, employment, and daily life. GTN offers practical training for students, newcomers, and community organizations.",
  hero: {
    headline: "Digital Literacy Training",
    subheadline:
...
GTN delivers digital literacy through workshops, small-group classes, and one-on-one coaching—in person at our Langley office, on-site at partner organizations, or online. We emphasize hands-on practice and progressive skill building so that learners gain confidence they can apply immediately, whether submitting a university assignment, completing a job application, or leading a virtual community meeting. By the end of your training, you will have practical competence in the tools that matter most for your goals—and a foundation to keep learning as technology continues to evolve. Book a consultation with GTN to assess your current skills and find the right workshop or coaching format for you or your organization.`,
  whoWeServe: [
    "International and domestic students building skills for academic success",
  ...
  faq: [
    {
      question: "Do I need my own computer for digital literacy training?",
      answer:
        "We recommend bringing your own device—laptop, tablet, or smartphone—so you learn on the tools you will use daily. If needed, we can discuss alternatives during your initial consultation.",
    },
    {
      question: "Is digital literacy training suitable for complete beginners?",
      answer:
        "Yes. Our programs start with fundamentals and progress at a pace suited to each learner. No prior computer experience is required for introductory modules.",
    },
    {
      question: "Can GTN provide digital literacy training for our organization?",
      answer:
        "Yes. We deliver customized workshops for schools, churches, nonprofits, and community groups. Content is tailored to your members' needs and available technology.",
    },
    {
      question: "Are sessions available in languages other than English?",
      answer:
        "GTN serves diverse communities and can discuss language support options during consultation. Our instructors use clear, accessible language and patient pacing for multilingual learners.",
    },
    {
      question: "How do I sign up for digital literacy training?",
      answer:
        "Contact us through our website or call 604-727-6553 to schedule an assessment and discuss available workshop dates and formats.",
    },
  ],
  relatedSlugs: [
