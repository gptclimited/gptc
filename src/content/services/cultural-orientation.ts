...
export const culturalOrientation: ServicePage = {
  ...
  metaDescription:
    "Cultural orientation programs helping newcomers understand Canadian social norms, workplace culture, and community life. Build confidence adapting to life in Canada with GTN.",
  hero: {
    headline: "Cultural Orientation for Life in Canada",
    subheadline:
...
GTN delivers cultural orientation for individuals, families, and groups through partner organizations, faith communities, and settlement programs. Our facilitators create safe spaces where questions are welcomed and cultural differences are explored with curiosity rather than judgment. Sessions can be tailored for specific audiences, including youth adjusting to Canadian schools, spouses entering the workforce for the first time, or professionals preparing for client-facing roles. Whether you arrived last month or have been in Canada for several years, cultural orientation helps you interpret situations accurately, reduce misunderstandings, and engage more fully in the communities where you live, work, and worship.`,
  ...
  benefits: [
    ...
    {
      title: "Workplace Culture Awareness",
      description:
  ...
  process: [
    {
      step: 1,
      title: "Cultural Background Discussion",
      description:
    ...
    {
      step: 2,
      title: "Orientation Curriculum Design",
      description:
    ...
    {
      step: 3,
      title: "Interactive Orientation Sessions",
      description:
    ...
    {
      step: 5,
      title: "Ongoing Cultural Mentorship",
      description:
  ...
  faq: [
    {
      question: "What topics are covered in cultural orientation?",
      answer:
        "Programs cover Canadian social customs, workplace culture, communication styles, public service interactions, holidays and traditions, and strategies for managing culture shock. Content is customized to participant needs.",
    },
    {
      question: "Is cultural orientation only for people who just arrived?",
      answer:
        "No. Newcomers at any stage benefit from orientation, especially when entering the workforce, enrolling children in school, or taking on community leadership roles for the first time in Canada.",
    },
    {
      question: "Will cultural orientation ask me to abandon my own culture?",
      answer:
        "Never. GTN's approach respects your heritage and helps you navigate Canadian contexts while maintaining your identity. Canada values multiculturalism, and our programs reflect that principle.",
    },
    {
      question: "Can cultural orientation be delivered to groups?",
      answer:
        "Yes. We offer group workshops for settlement agencies, faith communities, employers, and educational institutions serving newcomer populations.",
    },
    {
      question: "How do I register for cultural orientation with GTN?",
      answer:
        "Contact us through our website or Langley office to discuss individual or group orientation options and schedule your first session.",
    },
  ],
  relatedSlugs: ["cross-cultural-training", "settlement-support", "employment-readiness"],
};
