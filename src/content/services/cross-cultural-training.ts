...
export const crossCulturalTraining: ServicePage = {
  ...
  metaDescription:
    "Cross-cultural training for newcomers, employers, and community leaders in Canada. Build intercultural competence, reduce misunderstandings, and strengthen diverse teams with GTN.",
  hero: {
    headline: "Cross-Cultural Training",
    subheadline:
...
GTN's cross-cultural training is interactive, scenario-based, and grounded in real experiences from Canadian workplaces and communities. We work with settlement agencies, faith-based organizations, small businesses, and nonprofit teams to deliver training that produces lasting change—not just awareness, but practical competence. Programs can be delivered as half-day workshops, multi-session series, or integrated into broader onboarding and leadership development initiatives. Whether you are a newcomer preparing for your first Canadian job, a team lead managing diverse direct reports, or a community organizer facilitating dialogue across cultural lines, our programs equip you with tools to bridge differences, prevent unnecessary conflict, and build genuine connection across the cultural landscape of modern Canada.`,
  ...
  benefits: [
    {
      title: "Intercultural Communication Skills",
      description:
    ...
    {
      title: "Workplace Integration Support",
      description:
    ...
    {
      title: "Inclusive Team Development",
      description:
  ...
  process: [
    {
      step: 1,
      title: "Intercultural Needs Assessment",
      description:
    ...
    {
      step: 4,
      title: "Applied Practice & Feedback",
      description:
    ...
    {
      step: 5,
      title: "Integration & Follow-Up Resources",
      description:
  ...
  faq: [
    {
      question: "How is cross-cultural training different from cultural orientation?",
      answer:
        "Cultural orientation introduces newcomers to Canadian norms and daily life. Cross-cultural training builds deeper intercultural competence for navigating diverse environments—skills valuable for both newcomers and the organizations that employ them.",
    },
    {
      question: "Can employers request cross-cultural training for their teams?",
      answer:
        "Yes. GTN delivers workplace training for managers and staff supporting internationally trained employees, multicultural teams, and diverse client populations across Canada.",
    },
    {
      question: "Is this training suitable for newcomers with limited English?",
      answer:
        "We adapt delivery to participant language levels and can coordinate with interpreters or bilingual facilitators when needed. Contact us to discuss options.",
    },
    {
      question: "How long does cross-cultural training typically last?",
      answer:
        "Programs range from single half-day workshops to multi-session series depending on group size, goals, and depth of competency required.",
    },
    {
      question: "How do I arrange cross-cultural training with GTN?",
      answer:
        "Reach out through our contact page with details about your group, goals, and preferred format. We will recommend a training plan tailored to your needs.",
    },
  ],
  relatedSlugs: ["cultural-orientation", "community-engagement", "employment-readiness"],
};
