...
export const communityEngagement: ServicePage = {
  slug: "community-engagement",
  title: "Community Engagement",
  category: "Newcomer Integration",
  metaTitle: "Community Engagement for Newcomers in Canada | Global Training Network",
  metaDescription:
    "Community engagement programs helping newcomers build belonging in Canada. GTN connects newcomers with local networks, volunteer opportunities, and civic participation pathways.",
  hero: {
    headline: "Community Engagement for Newcomers",
    subheadline:
...
GTN partners with municipalities, faith-based organizations, settlement agencies, and community groups to create welcoming entry points for newcomer participation. We believe that engaged newcomers enrich the communities they join, and that communities become stronger when diversity is actively included rather than passively tolerated. Programs include community mapping exercises, guided first visits to local organizations, volunteer placement support, and pathways toward deeper civic involvement over time. Whether you want to volunteer at a food bank, join a recreational league, participate in a parent advisory committee, or eventually serve on a nonprofit board, our programs provide the knowledge, connections, and confidence to engage fully in Canadian community life and build the belonging that makes settlement sustainable.`,
  ...
  benefits: [
    ...
    {
      title: "Volunteer & Civic Pathways",
      description:
  ...
  process: [
    {
      step: 1,
      title: "Community Interest Mapping",
      description:
    ...
    {
      step: 5,
      title: "Sustained Engagement Planning",
      description:
  ...
  faq: [
    {
      question: "What kinds of community activities can GTN help me find?",
      answer:
        "We connect newcomers with volunteer opportunities, faith community programs, recreational leagues, parent groups, cultural associations, nonprofit initiatives, and local events in their area.",
    },
    {
      question: "I'm shy and don't know many people in Canada. Is community engagement for me?",
      answer:
        "Yes. Our programs are designed for newcomers at every comfort level. We provide orientation, warm introductions, and guided first experiences so you can build connections at your own pace.",
    },
    {
      question: "Can community engagement help my children integrate too?",
      answer:
        "Absolutely. We help families find youth programs, school community activities, sports leagues, and family-friendly events that support children's social integration alongside parents.",
    },
    {
      question: "Does GTN work with community organizations on newcomer inclusion?",
      answer:
        "Yes. We partner with municipalities, nonprofits, and faith groups to design engagement strategies that welcome and retain newcomer participation.",
    },
    {
      question: "How do I get started with community engagement support?",
      answer:
        "Contact us through our website or Langley office. Tell us about your community, interests, and goals, and we will recommend engagement pathways suited to your situation.",
    },
  ],
  relatedSlugs: ["newcomer-integration", "settlement-support", "cultural-orientation"],
};
