...
export const employmentReadiness: ServicePage = {
  ...
  metaDescription:
    "Employment readiness training for newcomers in Canada. GTN supports résumé writing, interview skills, credential recognition, and career pathways in the Canadian job market.",
  hero: {
    headline: "Employment Readiness for the Canadian Job Market",
    subheadline:
...
GTN works with newcomers across sectors including healthcare, engineering, education, trades, business, and community services. We partner with settlement agencies, employment programs, and faith-based organizations to deliver individual coaching and group workshops. Our approach recognizes that employment readiness is not just about getting hired—it is about building a sustainable career, understanding worker rights in Canada, negotiating fair compensation, and contributing your talents to the economy and communities that welcome you. From first application to first day on the job and beyond, we walk alongside you through every stage of your Canadian career journey.`,
  ...
  benefits: [
    {
      title: "Canadian-Format Résumé & Cover Letters",
      description:
    ...
    {
      title: "Credential Recognition Guidance",
      description:
    ...
    {
      title: "Workplace Rights & Culture",
      description:
  ...
  process: [
    ...
    {
      step: 2,
      title: "Canadian Job Market Orientation",
      description:
    ...
    {
      step: 3,
      title: "Application Materials Development",
      description:
    ...
    {
      step: 4,
      title: "Interview & Networking Practice",
      description:
    ...
    {
      step: 5,
      title: "Job Search Support & Follow-Up",
      description:
  ...
  faq: [
    {
      question: "Can GTN help with credential recognition in Canada?",
      answer:
        "We provide guidance on credential assessment bodies, licensing pathways, and alternative routes to employment in regulated professions. We connect you with appropriate resources for your specific field.",
    },
    {
      question: "I have years of experience abroad. Will employers in Canada recognize it?",
      answer:
        "Canadian employers value international experience when it is presented effectively. Our employment readiness programs help you translate your background into language and formats that resonate with Canadian recruiters.",
    },
    {
      question: "Do you offer employment readiness for specific industries?",
      answer:
        "Yes. We tailor coaching to sector-specific hiring practices, including healthcare, engineering, education, trades, IT, and community services. Share your field when you contact us.",
    },
    {
      question: "Is employment readiness available for international students?",
      answer:
        "Absolutely. We support international graduates preparing for post-graduation work permits, co-op placements, and transition into the Canadian labour market.",
    },
    {
      question: "How do I begin employment readiness support with GTN?",
      answer:
        "Book a consultation through our contact page or call our Langley office. We will discuss your career background, goals, and the employment readiness services best suited to your situation.",
    },
  ],
  relatedSlugs: ["settlement-support", "cultural-orientation", "cross-cultural-training"],
};
